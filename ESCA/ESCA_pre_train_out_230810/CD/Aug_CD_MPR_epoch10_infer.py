...
if __name__ == '__main__':
    ...
    class CFG:
        ...
        wd = 1e-5
        lr_drop = 8
        ckpt_fold = "CD_MPR Checkpoint"
        ckpt_name = "efficientnetb0_img1024_bs32_fold5_epoch30"  
        pretrained_ckpt_path = r"C:\Users\Administrator\bin\huangzongyao\torchkit\classification\tools\CD_MPR Checkpoint\efficientnetb0_img1024_bs32_fold5_epoch5\best_fold1_epoch4.pth"
        
    
    # 按照集合(train、test、valid)来分割数据
    df = pd.read_csv(r'E:\zhouyehan\single_label_Proj\CD_df_all_1024_filter_train_val.csv') #! Your csv file path
    ...
    if test_flag:
        ...
        print(f'#'*40, flush=True)
        test_data = pd.read_csv(r"E:\zhouyehan\single_label_Proj\CD_df_all_1024_filter_test.csv")
        data_transforms = build_transforms(CFG)
        ...
        ckpt_paths = glob(r'C:\Users\Administrator\bin\huangzongyao\torchkit\classification\tools\CD_MPR Checkpoint\efficientnetb0_img1024_bs32_fold5_epoch5\best_fold1_epoch4.pth') #! 替换做好的pth文件路径
        ...
        test_log.to_csv(r'E:\zhouyehan\single_label_Proj\CD_test_log.csv')
