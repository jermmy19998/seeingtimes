...
def train_one_epoch(model, train_loader, optimizer, losses_dict, CFG):
    ...
    pbar = tqdm(enumerate(train_loader), total=len(train_loader), desc='Train ',dynamic_ncols=True)
...
def valid_one_epoch(model, valid_loader, CFG):
    ...
    pbar = tqdm(enumerate(valid_loader), total=len(valid_loader), desc='Valid ',dynamic_ncols=True)
...
if __name__ == '__main__':
    ...
    class CFG:
        ...
        train_path = "/home/zanzhuheng/Desktop/Working/birds/鸟类品种识别挑战赛训练集"
        is_train = True
        is_test = False
