...
if __name__ == '__main__':
    ...
    class CFG:
        ...
        TTA = True
        # step6: files
        ckpt_fold = "ckpt_leaves"
        ckpt_name = "L_efficientnetb0_img128128_bs32_fold2_epoch3"  # for submit. # 
        train_path = "/home/zanzhuheng/Desktop/Working/leaves/train_set"
    ...
    if train_val_flag:
        ...
        ###############################################################
        class_names = {'healthy':0, 'powdery_mildew':1, 'rust':2, 'scab':3}
